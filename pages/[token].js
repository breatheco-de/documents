                            ...
                            <div className="col-md-7 col-12">
                                ...
                                <div className="row ">
                                    <div className="col-md-12 col-12 p-0">
                                        <div className="d-flex" >
                                            ...
                                            <div>
                                                <p className="mb-0">{cert && cert.user.first_name + " " + cert.user.last_name}</p>
                                                <a className="color-4geeks" target="__blank" href="/#">{strings["view all certificates"]} {SVGS.arrowRight}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-sm-4 col-12 d-flex">
                                        ...
                                        <div>
                                            <p className="mb-0"><strong>{strings["Total Hours"]}</strong></p>
                                    ...
                                    <div className="col-sm-4 col-12 d-flex">
                                        ...
                                        <div>
                                            <p className="mb-0"><strong>{strings["Issued On"]}</strong></p>
                                    ...
                                    <div className="col-sm-4 col-12 d-flex">
                                        ...
                                        <div >
                                            <p className="mb-0"><strong>{strings["Issuer"]}</strong></p>
                                            <a target="__blank" className="color-4geeks" href={cert.academy.url || "https://4geeksacademy.com/"}>{strings["website"]}{SVGS.arrowRight}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-3 p-0">
                                ...
                                <div className="row pb-2">
                                    <div className="col-md-12 col-12 d-flex justify-content-center">
                                        <a className="bg-4geeks button" href={`/pdf/${query.token}`} target="_blank">
                                            {SVGS.download}
